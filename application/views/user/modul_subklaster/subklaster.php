        ...
        <div class="container-fluid">
          ...
          <div class="card card-outline card-info">
            <div class="card-header">
              ...
              <a style="margin-right: 10px" class="btn btn-secondary btn-sm float-right" href="<?php echo base_url('user/klaster');?>">
            ...
            <div class="card-body">
              ...
              <div class="input-group ">
                <input class="form-control col-sm-12" name="seachsubklasterUser" id="seachsubklasterUser" type="text" placeholder="Search" aria-label="Search">
              ...
              <table id="subklasterDataUser" class="table table-striped" style="width:100%">
                <thead>
                  <tr>

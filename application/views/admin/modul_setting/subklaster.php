        ...
        <div class="container-fluid">
          ...
          <div class="card card-outline card-info">
            <div class="card-header">
              ...
              <a style="margin-right: 10px" class="btn btn-secondary btn-sm float-right" href="<?php echo base_url('admin/pilih_user/'.$this->encrypt->encode($user->id));?>">
                    <i class="fas fa-arrow-left"></i>&ensp;Back
                  </a>
            </div>
            <div class="card-body">
              <!-- SEARCH FORM -->
              <input type="hidden" name="id_subklaster" value="<?= $klaster->id ;?>">
              <input type="hidden" name="id_user" value="<?= $user->id ;?>">
              <div class="input-group ">
                <input class="form-control col-sm-12" name="searchSsubklaster" id="searchSsubklaster" type="text" placeholder="Search" aria-label="Search">
              ...
              <table id="SsubklasterData" class="table table-striped" style="width:100%">
                <thead>
                  <tr>

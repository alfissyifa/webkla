          ...
          <div class="row">
            <div class="col-md-9">
              ...
              <div class="card card-outline card-primary">
                ...
                <form role="form" action="<?php echo base_url('admin/laporanpinjamanPdf')?>" method="post" target="blank">
                  <div class="card-body">
                  ...
                  <div class="card-footer justify-content-between">
                    <a class="btn btn-sm btn-danger" href="<?= base_url('admin/laporanPinjaman')?>"><i class="fa fa-undo"></i>&ensp;Reset</a>

          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url('admin/laporanSimpanansukarela')?>"><small><?= $page ;?></small></a></li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
          ...
          <div class="row">
            <div class="col-md-9">
              ...
              <div class="card card-outline card-primary">
                ...
                <form role="form" action="<?php echo base_url('admin/laporansimpanansukarelaPdf')?>" method="post" target="blank">
                  <div class="card-body">
                  ...
                  <div class="card-footer justify-content-between">
                    <a class="btn btn-sm btn-danger" href="<?= base_url('admin/laporanSimpanansukarela')?>"><i class="fa fa-undo"></i>&ensp;Reset</a>

								...
								<table border="1" cellpadding="2" cellspacing="0" style="width:100%" >
									<tbody>
										<tr style="height:40px;background:#b7b5b5;">
											...
											<th style="text-align:center"><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif">Tanggal<br>Pinjaman</span></span></th>
											...
											<th style="text-align:center"><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif">Jumlah<br>Pinjaman</span></span></th>
											<th style="text-align:center"><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif">Tenor</span></span></th>
										...
										<tr>
											...
											<td style="text-align:right;padding-right: 5px"><?=number_format($all->jumlah_pinjaman,0,',','.')?></td>
											<td style="text-align:center;"><?= $all->tenor;?></td>

			...
			<p style="text-align:center"><img alt="" src="<?= base_url('assets/');?>images/icon.png" style="float:left; height:80px; width:80px " />
				<span style="font-size:20px"><span style="font-family:Times New Roman,Times,serif"><strong>KOPERASI KARYAWAN LAJU PERDANA INDAH</strong>
					...
					<div style="padding-left: 15px; padding-right: 20px;">
						<div style="padding-left:15px; padding-right:20px">
							<p style="text-align:center"><span style="font-size:18px"><span style="font-family:Times New Roman,Times,serif"><strong>LAPORAN SIMPANAN WAJIB</strong></span></span></p>
								...
								<table border="1" cellpadding="2" cellspacing="0" style="width:100%" >
									<tbody>
										<tr style="height:40px;background:#b7b5b5;">
											...
											<th style="text-align:center"><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif">Tanggal<br>Simpanan Wajib</span></span></th>
											...
											<th style="text-align:center"><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif">Jumlah<br>Simpanan Wajib</span></span></th>
										</tr>
										<?php 

			...
			<p style="text-align:center"><img alt="" src="<?= base_url('assets/');?>images/icon.png" style="float:left; height:80px; width:80px " />
				<span style="font-size:20px"><span style="font-family:Times New Roman,Times,serif"><strong>KOPERASI KARYAWAN LAJU PERDANA INDAH</strong>
					...
					<div style="padding-left: 15px; padding-right: 20px;">
						<div style="padding-left:15px; padding-right:20px">
							<p style="text-align:center"><span style="font-size:18px"><span style="font-family:Times New Roman,Times,serif"><strong>LAPORAN ANGSURAN</strong></span></span></p>
								...
								<table border="1" cellpadding="2" cellspacing="0" style="width:100%" >
									<tbody>
										<tr style="height:40px;background:#b7b5b5;">
											...
											<th style="text-align:center"><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif">Data<br>Anggota</span></span></th>
											<th style="text-align:center"><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif">Data<br>Pinjaman</span></span></th>
											...
											<th style="text-align:center"><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif">Angsuran<br>Ke-</span></span></th>
										...
										<tr>
											...
											<td style="text-align:center;"><?= $all->tanggal_pinjaman;?><br><?=number_format($all->jumlah_pinjaman,0,',','.')?></td>
											<td style="text-align:center;"><?= date('d/m/Y', strtotime($all->tanggal)) ?></td>
											<td style="text-align:center;"><?= $all->angsuran_ke;?></td>

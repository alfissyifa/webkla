        ...
        <div class="container-fluid">
          ...
          <div class="card card-outline card-info">
            <div class="card-header">
              <h6 class="card-title " text-align="center"><strong>KLASTER</strong></h6>
              <a class="btn btn-sm btn-outline-info float-right" href="<?= base_url('admin/klaster_add')?>">
            ...
            <div class="card-body">
              ...
              <table id="klasterData" class="table table-striped" style="width:100%">
                <thead>
                  <tr>

      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="card card-outline card-info">
            ...
            <div class="card-body">
              <!-- SEARCH FORM -->
              <input type="hidden" name="id_user_jawaban" value="<?= $user->id ;?>">
              

              <div class="input-group ">
                <input class="form-control col-sm-12" name="seachListKlaster_jawaban" id="seachListKlaster_jawaban" type="text" placeholder="Search" aria-label="Search">
              ...
              <table id="klasterDataUser_jawaban" class="table table-striped" style="width:100%">
                <thead>
                  <tr>

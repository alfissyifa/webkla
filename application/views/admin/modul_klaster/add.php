            ...
            <div class="container-fluid col-sm-8">
              ...
              <div class="card card-outline card-info">
                <div class="card-header">
                  <h6 class="card-title " text-align="center"><strong>KLASTER ADD</strong></h6>
                ...
                <div class="card-body">
                  ...
                  <form action="<?= base_url('admin/klaster_add')?>" method="post">
                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col-md-9">  
                           <textarea style="height: 100px;" type="text" name="nama_klaster" class="form-control" id="nama_klaster"><?= $nama_klaster; ?></textarea>
                        </div>
                      </div>
                    </div>
